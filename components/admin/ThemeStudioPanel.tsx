...
export function ThemeStudioPanel() {
  ...
  function onImportFile(file: File | null) {
    ...
    reader.onload = () => {
      ...
      setMessage(`Imported “${parsed.name}”. Save & activate to publish.`);
    };
        ...
        <section className="panel admin-card">
          ...
          <div className="admin-form-grid">
            ...
            <label className="field">
              ...
              <input
                value={draft.radius}
                onChange={(e) => updateDraft({ ...draft, radius: e.target.value })}
              />
            </label>
            <label className="field">
              <span>Font</span>
              <input
                value={draft.font}
                onChange={(e) => updateDraft({ ...draft, font: e.target.value })}
              />
            </label>
            <label className="field">
          ...
          <div className="admin-form-row">
            <button type="button" className="btn btn-primary" disabled={saving} onClick={() => void saveAndActivate()}>
