...
| `EMAIL_WEBHOOK_URL` | HTTPS URL of **your** inbound webhook (n8n/Make/Zapier/Power Automate). JustX POSTs email JSON there — **not** generated by JustX. See [`EMAIL_OUTBOX.md`](EMAIL_OUTBOX.md) / [`EMAIL_WEBHOOK.md`](EMAIL_WEBHOOK.md) |
