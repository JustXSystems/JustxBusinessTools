/**
 * Canonical admin deep links (keep in sync with server/src/lib/admin/deep-links.ts).
 */

export type ApprovalsKind = "profile" | "user" | "payment_op" | "upi_claim";

export const adminDeepLink = {
  approvals: (kind?: ApprovalsKind) =>
